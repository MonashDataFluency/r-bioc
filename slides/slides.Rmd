...
| --- | --- | --- |
| DNA sequence | FASTA, FASTQ, 2bit(R) | Biostrings::DNAStringSet, BSgenome(R), rtracklayer::TwoBitFile(R) |
| Amino acid sequence | FASTA | Biostrings::AAStringSet |
| Genomic features | GTF(I), GFF(I), BED(I) | GenomicRanges::GRanges, GenomicFeatures::TxDb, ensembldb::EnsDb |
...
| Numeric matrix (gene expression, etc) | CSV, TSV, HDF5(R) | matrix, HDF5Array, DelayedArray, SummarizedExperiment, SingleCellExperiment, ... |
